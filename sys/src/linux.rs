...
pub const LIBRAW_MINOR_VERSION: u32 = 23;
pub const LIBRAW_PATCH_VERSION: u32 = 0;
pub const LIBRAW_SHLIB_CURRENT: u32 = 25;
pub const LIBRAW_SHLIB_REVISION: u32 = 0;
pub const LIBRAW_SHLIB_AGE: u32 = 0;
pub const LIBRAW_ABI_VERSION: u32 = 587202561;
...
pub const LibRaw_processing_options_LIBRAW_RAWOPTIONS_LEGACY_SAMSUNG3_DECODER:
...
pub const LibRaw_processing_options_LIBRAW_RAWOPTIONS_CANON_CHECK_ASSHOT_CCT:
    LibRaw_processing_options = 268435456;
pub const LibRaw_processing_options_LIBRAW_RAWOPTIONS_CR3_DYNAMIC_FRAME_LIMIT:
...
const _: () = {
    ["Size of libraw_canon_makernotes_t"]
        [::core::mem::size_of::<libraw_canon_makernotes_t>() - 172usize];
    ...
    ["Offset of field: libraw_canon_makernotes_t::AsShotCT"]
        [::core::mem::offset_of!(libraw_canon_makernotes_t, AsShotCT) - 124usize];
    ["Offset of field: libraw_canon_makernotes_t::DefaultCropAbsolute"]
        [::core::mem::offset_of!(libraw_canon_makernotes_t, DefaultCropAbsolute) - 128usize];
    ["Offset of field: libraw_canon_makernotes_t::RecommendedImageArea"]
        [::core::mem::offset_of!(libraw_canon_makernotes_t, RecommendedImageArea) - 136usize];
    ["Offset of field: libraw_canon_makernotes_t::LeftOpticalBlack"]
        [::core::mem::offset_of!(libraw_canon_makernotes_t, LeftOpticalBlack) - 144usize];
    ["Offset of field: libraw_canon_makernotes_t::UpperOpticalBlack"]
        [::core::mem::offset_of!(libraw_canon_makernotes_t, UpperOpticalBlack) - 152usize];
    ["Offset of field: libraw_canon_makernotes_t::ActiveArea"]
        [::core::mem::offset_of!(libraw_canon_makernotes_t, ActiveArea) - 160usize];
    ["Offset of field: libraw_canon_makernotes_t::ISOgain"]
        [::core::mem::offset_of!(libraw_canon_makernotes_t, ISOgain) - 168usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone, PartialEq)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of libraw_colordata_t"][::core::mem::size_of::<libraw_colordata_t>() - 187104usize];
    ...
    ["Offset of field: libraw_colordata_t::as_shot_wb_corr"]
        [::core::mem::offset_of!(libraw_colordata_t, as_shot_wb_corr) - 187084usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone, PartialEq, Eq)]
...
const _: () = {
    ["Size of libraw_raw_unpack_params_t"]
        [::core::mem::size_of::<libraw_raw_unpack_params_t>() - 56usize];
    ...
    ["Offset of field: libraw_raw_unpack_params_t::cr3_maxframes"]
        [::core::mem::offset_of!(libraw_raw_unpack_params_t, cr3_maxframes) - 48usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone, PartialEq)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of libraw_rawdata_t"][::core::mem::size_of::<libraw_rawdata_t>() - 187816usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of libraw_makernotes_t"][::core::mem::size_of::<libraw_makernotes_t>() - 3168usize];
    ...
    ["Offset of field: libraw_makernotes_t::nikon"]
        [::core::mem::offset_of!(libraw_makernotes_t, nikon) - 176usize];
    ["Offset of field: libraw_makernotes_t::hasselblad"]
        [::core::mem::offset_of!(libraw_makernotes_t, hasselblad) - 472usize];
    ["Offset of field: libraw_makernotes_t::fuji"]
        [::core::mem::offset_of!(libraw_makernotes_t, fuji) - 856usize];
    ["Offset of field: libraw_makernotes_t::olympus"]
        [::core::mem::offset_of!(libraw_makernotes_t, olympus) - 1208usize];
    ["Offset of field: libraw_makernotes_t::sony"]
        [::core::mem::offset_of!(libraw_makernotes_t, sony) - 1672usize];
    ["Offset of field: libraw_makernotes_t::kodak"]
        [::core::mem::offset_of!(libraw_makernotes_t, kodak) - 1856usize];
    ["Offset of field: libraw_makernotes_t::panasonic"]
        [::core::mem::offset_of!(libraw_makernotes_t, panasonic) - 2100usize];
    ["Offset of field: libraw_makernotes_t::pentax"]
        [::core::mem::offset_of!(libraw_makernotes_t, pentax) - 2168usize];
    ["Offset of field: libraw_makernotes_t::phaseone"]
        [::core::mem::offset_of!(libraw_makernotes_t, phaseone) - 2204usize];
    ["Offset of field: libraw_makernotes_t::ricoh"]
        [::core::mem::offset_of!(libraw_makernotes_t, ricoh) - 2656usize];
    ["Offset of field: libraw_makernotes_t::samsung"]
        [::core::mem::offset_of!(libraw_makernotes_t, samsung) - 2728usize];
    ["Offset of field: libraw_makernotes_t::common"]
        [::core::mem::offset_of!(libraw_makernotes_t, common) - 2864usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone, PartialEq, Eq)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of libraw_data_t"][::core::mem::size_of::<libraw_data_t>() - 381624usize];
    ...
    ["Offset of field: libraw_data_t::shootinginfo"]
        [::core::mem::offset_of!(libraw_data_t, shootinginfo) - 5096usize];
    ["Offset of field: libraw_data_t::params"]
        [::core::mem::offset_of!(libraw_data_t, params) - 5240usize];
    ["Offset of field: libraw_data_t::rawparams"]
        [::core::mem::offset_of!(libraw_data_t, rawparams) - 5544usize];
    ["Offset of field: libraw_data_t::progress_flags"]
        [::core::mem::offset_of!(libraw_data_t, progress_flags) - 5600usize];
    ["Offset of field: libraw_data_t::process_warnings"]
        [::core::mem::offset_of!(libraw_data_t, process_warnings) - 5604usize];
    ["Offset of field: libraw_data_t::color"]
        [::core::mem::offset_of!(libraw_data_t, color) - 5608usize];
    ["Offset of field: libraw_data_t::other"]
        [::core::mem::offset_of!(libraw_data_t, other) - 192712usize];
    ["Offset of field: libraw_data_t::thumbnail"]
        [::core::mem::offset_of!(libraw_data_t, thumbnail) - 193512usize];
    ["Offset of field: libraw_data_t::thumbs_list"]
        [::core::mem::offset_of!(libraw_data_t, thumbs_list) - 193536usize];
    ["Offset of field: libraw_data_t::rawdata"]
        [::core::mem::offset_of!(libraw_data_t, rawdata) - 193800usize];
    ["Offset of field: libraw_data_t::parent_class"]
        [::core::mem::offset_of!(libraw_data_t, parent_class) - 381616usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone, PartialEq, Eq)]
...
pub struct pana8_tags_t {
    ...
    pub tile_c: u16,
    pub tile_r: u16,
    pub tile_offs: [INT64; 12usize],
    pub tile_left: [u16; 12usize],
    pub tile_csize: [u32; 12usize],
    pub tile_wi: [u16; 12usize],
    pub tile_he: [u16; 12usize],
    pub tile_top: [u16; 12usize],
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of pana8_tags_t"][::core::mem::size_of::<pana8_tags_t>() - 392usize];
    ...
    ["Offset of field: pana8_tags_t::tile_c"]
        [::core::mem::offset_of!(pana8_tags_t, tile_c) - 148usize];
    ["Offset of field: pana8_tags_t::tile_r"]
        [::core::mem::offset_of!(pana8_tags_t, tile_r) - 150usize];
    ["Offset of field: pana8_tags_t::tile_offs"]
        [::core::mem::offset_of!(pana8_tags_t, tile_offs) - 152usize];
    ["Offset of field: pana8_tags_t::tile_left"]
        [::core::mem::offset_of!(pana8_tags_t, tile_left) - 248usize];
    ["Offset of field: pana8_tags_t::tile_csize"]
        [::core::mem::offset_of!(pana8_tags_t, tile_csize) - 272usize];
    ["Offset of field: pana8_tags_t::tile_wi"]
        [::core::mem::offset_of!(pana8_tags_t, tile_wi) - 320usize];
    ["Offset of field: pana8_tags_t::tile_he"]
        [::core::mem::offset_of!(pana8_tags_t, tile_he) - 344usize];
    ["Offset of field: pana8_tags_t::tile_top"]
        [::core::mem::offset_of!(pana8_tags_t, tile_top) - 368usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone, PartialEq, Eq)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of unpacker_data_t"][::core::mem::size_of::<unpacker_data_t>() - 2760usize];
    ...
    ["Offset of field: unpacker_data_t::crx_header"]
        [::core::mem::offset_of!(unpacker_data_t, crx_header) - 584usize];
    ["Offset of field: unpacker_data_t::crx_track_selected"]
        [::core::mem::offset_of!(unpacker_data_t, crx_track_selected) - 2632usize];
    ["Offset of field: unpacker_data_t::crx_track_count"]
        [::core::mem::offset_of!(unpacker_data_t, crx_track_count) - 2636usize];
    ["Offset of field: unpacker_data_t::CR3_CTMDtag"]
        [::core::mem::offset_of!(unpacker_data_t, CR3_CTMDtag) - 2640usize];
    ["Offset of field: unpacker_data_t::CR3_Version"]
        [::core::mem::offset_of!(unpacker_data_t, CR3_Version) - 2642usize];
    ["Offset of field: unpacker_data_t::CM_found"]
        [::core::mem::offset_of!(unpacker_data_t, CM_found) - 2644usize];
    ["Offset of field: unpacker_data_t::is_NikonTransfer"]
        [::core::mem::offset_of!(unpacker_data_t, is_NikonTransfer) - 2648usize];
    ["Offset of field: unpacker_data_t::is_Olympus"]
        [::core::mem::offset_of!(unpacker_data_t, is_Olympus) - 2652usize];
    ["Offset of field: unpacker_data_t::OlympusDNG_SubDirOffsetValid"]
        [::core::mem::offset_of!(unpacker_data_t, OlympusDNG_SubDirOffsetValid) - 2656usize];
    ["Offset of field: unpacker_data_t::is_Sony"]
        [::core::mem::offset_of!(unpacker_data_t, is_Sony) - 2660usize];
    ["Offset of field: unpacker_data_t::is_pana_raw"]
        [::core::mem::offset_of!(unpacker_data_t, is_pana_raw) - 2664usize];
    ["Offset of field: unpacker_data_t::is_PentaxRicohMakernotes"]
        [::core::mem::offset_of!(unpacker_data_t, is_PentaxRicohMakernotes) - 2668usize];
    ["Offset of field: unpacker_data_t::dng_frames"]
        [::core::mem::offset_of!(unpacker_data_t, dng_frames) - 2672usize];
    ["Offset of field: unpacker_data_t::raw_stride"]
        [::core::mem::offset_of!(unpacker_data_t, raw_stride) - 2752usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone, PartialEq, Eq)]
...
const _: () = {
    ["Size of libraw_internal_data_t"]
        [::core::mem::size_of::<libraw_internal_data_t>() - 2896usize];
